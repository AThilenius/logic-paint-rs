/* tslint:disable */
/* eslint-disable */
export function import_legacy_blueprint(a: number, b: number): Array;
...
export function compilerresults_get_trace_atoms(a: number, b: number): Array;
...
export function viewport_draw(a: number, b: number, c: number): Array;
...
export function __wbg_get_editor_cursor_style(a: number): Array;
...
export function __wbg_get_editordispatchresult_tools_persist(a: number): Array;
export function __wbg_set_editordispatchresult_tools_persist(a: number, b: number, c: number): void;
export function __wbg_get_editordispatchresult_camera(a: number): number;
export function __wbg_set_editordispatchresult_camera(a: number, b: number): void;
export function __wbg_toolpersist_free(a: number, b: number): void;
export function __wbg_get_toolpersist_tool_name(a: number): Array;
export function __wbg_set_toolpersist_tool_name(a: number, b: number, c: number): void;
export function __wbg_get_toolpersist_serialized_state(a: number): Array;
export function __wbg_set_toolpersist_serialized_state(a: number, b: number, c: number): void;
export function editor_new(a: number): number;
...
export function __wbg_get_keystate_key_code(a: number): Array;
export function __wbg_set_keystate_key_code(a: number, b: number, c: number): void;
export function __wbg_get_keystate_key(a: number): Array;
...
export function __wbg_get_iostate_scroll_button(a: number): number;
export function __wbg_set_iostate_scroll_button(a: number, b: number): void;
export function __wbg_get_iostate_drag(a: number): number;
export function __wbg_set_iostate_drag(a: number, b: number): void;
export function __wbg_get_iostate_keys(a: number): Array;
...
export function iostate_get_drag_path(a: number): Array;
export function buffer_to_base64_string(a: number): Array;
export function buffer_to_bytes(a: number): Array;
export function buffer_from_base64_string(a: number, b: number): Array;
export function buffer_from_bytes(a: number, b: number): Array;
