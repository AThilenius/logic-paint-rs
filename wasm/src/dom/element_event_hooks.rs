    ...
    pub fn new(
        ...
        // Register event handlers
        {
            ...
            let closure = Closure::wrap(Box::new(move |event: MouseEvent| {
                rc.borrow_mut()
                    .on_mouse(ElementMouseEvent::MouseDown(event));
            }) as Box<dyn FnMut(_)>);
            html_element
        ...
        }
        {
            let rc = target.clone();
            let closure = Closure::wrap(Box::new(move |event: MouseEvent| {
                rc.borrow_mut().on_mouse(ElementMouseEvent::MouseUp(event));
            }) as Box<dyn FnMut(_)>);
            html_element
        ...
        }
        {
            ...
            let closure = Closure::wrap(Box::new(move |event: MouseEvent| {
                rc.borrow_mut()
                    .on_mouse(ElementMouseEvent::MouseMove(event));
            }) as Box<dyn FnMut(_)>);
            html_element
